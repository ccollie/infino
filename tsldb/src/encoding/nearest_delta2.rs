...
use crate::encoding::unmarshal_var_int_vec;
use crate::utils::error::TsldbError;
use crate::utils::pool::get_int64s;
...
pub fn unmarshal_int64_nearest_delta2(
    ...
    if items_count < 2 {
        return Err(TsldbError::CannotDeserialize(format!(
