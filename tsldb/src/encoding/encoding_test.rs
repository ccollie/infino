#[cfg(test)]
mod tests {
    use crate::encoding::{ensure_non_decreasing_sequence, is_const, is_delta_const, is_gauge, marshal_timestamps, marshal_values, unmarshal_timestamps, unmarshal_values};
    use crate::{
    ...
    use crate::encoding::MarshalType::{Const, DeltaConst, NearestDelta, NearestDelta2};
