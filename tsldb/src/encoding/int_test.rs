...
mod tests {
    ...
    use std::fmt::Display;
    use crate::encoding::{marshal_bytes, marshal_i16, marshal_i64, marshal_u16, marshal_u32, marshal_u64, marshal_var_i64, marshal_var_u64, unmarshal_bytes, unmarshal_i16, unmarshal_i64, unmarshal_u16, unmarshal_u32, unmarshal_u64, unmarshal_var_i64, unmarshal_var_u64};
